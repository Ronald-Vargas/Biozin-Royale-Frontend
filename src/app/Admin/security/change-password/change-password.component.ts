...
@Component({
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, AtmosphereComponent, AdminHeaderComponent, AdminNavComponent, FieldComponent],
  selector: 'app-admin-security-change-password',
  templateUrl: './change-password.component.html',
  styleUrls: ['./change-password.component.scss'],
})
export class AdminSecurityChangePasswordComponent {
  form: FormGroup;
  loading = false;
  errorMsg = '';
  successMsg = '';
  ...
  goBack() { this.router.navigate(['/admin/seguridad']); }
